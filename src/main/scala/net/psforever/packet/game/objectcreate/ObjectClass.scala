...
object ObjectClass {
  ...
  final val aphelion_armor_siphon            = 80
  final val aphelion_armor_siphon_left       = 81
  final val aphelion_armor_siphon_right      = 82
  ...
  final val aphelion_ntu_siphon              = 93
  final val aphelion_ntu_siphon_left         = 94
  final val aphelion_ntu_siphon_right        = 95
  ...
  /**
    ...
    * This function net.psforever.services `0x18` `ObjectCreateDetailedMessage` packet data.<br>
    * <br>
  ...
  /**
    * Given an object class, retrieve the `Codec` used to parse and translate the constructor data for that type.
    * This function net.psforever.services `0x17` `ObjectCreateMessage` packet data.<br>
    * <br>
  ...
  def selectDataCodec(objClass: Int): Codec[ConstructorData] =
    (objClass: @switch) match {
      ...
      case ObjectClass.aphelion_armor_siphon            => ConstructorData(WeaponData.codec2, "siphon")
      case ObjectClass.aphelion_armor_siphon_left       => ConstructorData(WeaponData.codec2, "siphon")
      case ObjectClass.aphelion_armor_siphon_right      => ConstructorData(WeaponData.codec2, "siphon")
      case ObjectClass.aphelion_immolation_cannon       => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_laser                   => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_laser_left              => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_laser_right             => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_ntu_siphon              => ConstructorData(WeaponData.codec2, "siphon")
      case ObjectClass.aphelion_ntu_siphon_left         => ConstructorData(WeaponData.codec2, "siphon")
      case ObjectClass.aphelion_ntu_siphon_right        => ConstructorData(WeaponData.codec2, "siphon")
      case ObjectClass.aphelion_plasma_rocket_pod       => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_ppa                     => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_ppa_left                => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_ppa_right               => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_starfire                => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_starfire_left           => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_starfire_right          => ConstructorData(WeaponData.codec2, "weapon")
      ...
      case ObjectClass.colossus_armor_siphon            => ConstructorData(WeaponData.codec2, "siphon")
      case ObjectClass.colossus_armor_siphon_left       => ConstructorData(WeaponData.codec2, "siphon")
      case ObjectClass.colossus_armor_siphon_right      => ConstructorData(WeaponData.codec2, "siphon")
      ...
      case ObjectClass.colossus_chaingun                => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.colossus_chaingun_left           => ConstructorData(WeaponData.codec2, "weapon")
      ...
      case ObjectClass.colossus_ntu_siphon              => ConstructorData(WeaponData.codec2, "siphon")
      case ObjectClass.colossus_ntu_siphon_left         => ConstructorData(WeaponData.codec2, "siphon")
      case ObjectClass.colossus_ntu_siphon_right        => ConstructorData(WeaponData.codec2, "siphon")
      ...
      case ObjectClass.peregrine_armor_siphon           => ConstructorData(WeaponData.codec2, "siphon")
      case ObjectClass.peregrine_armor_siphon_left      => ConstructorData(WeaponData.codec2, "siphon")
      case ObjectClass.peregrine_armor_siphon_right     => ConstructorData(WeaponData.codec2, "siphon")
      ...
      case ObjectClass.peregrine_dual_rocket_pods       => ConstructorData(WeaponData.codec2, "weapon")
      ...
      case ObjectClass.peregrine_ntu_siphon             => ConstructorData(WeaponData.codec2, "siphon")
      case ObjectClass.peregrine_ntu_siphon_left        => ConstructorData(WeaponData.codec2, "siphon")
      case ObjectClass.peregrine_ntu_siphon_right       => ConstructorData(WeaponData.codec2, "siphon")
      ...
      case ObjectClass.peregrine_sparrow_right          => ConstructorData(WeaponData.codec2, "weapon")
  ...
  def selectDataDroppedCodec(objClass: Int): Codec[ConstructorData] =
    (objClass: @switch) match {
      ...
      case ObjectClass.aphelion_immolation_cannon  => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_armor_siphon       => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.aphelion_armor_siphon_left  => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.aphelion_armor_siphon_right => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.aphelion_laser              => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_laser_left         => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_laser_right        => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_ntu_siphon         => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.aphelion_ntu_siphon_left    => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.aphelion_ntu_siphon_right   => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.aphelion_plasma_rocket_pod  => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_ppa                => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_ppa_left           => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_ppa_right          => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_starfire           => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_starfire_left      => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_starfire_right     => DroppedItemData(WeaponData.codec2, "weapon")
      ...
      case ObjectClass.colossus_armor_siphon       => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.colossus_armor_siphon_left  => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.colossus_armor_siphon_right => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.colossus_burster            => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.colossus_burster_left       => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.colossus_burster_right      => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.colossus_chaingun           => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.colossus_chaingun_left      => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.colossus_chaingun_right     => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.colossus_cluster_bomb_pod   => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.colossus_dual_100mm_cannons => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.colossus_ntu_siphon         => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.colossus_ntu_siphon_left    => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.colossus_ntu_siphon_right   => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.colossus_tank_cannon        => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.colossus_tank_cannon_left   => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.colossus_tank_cannon_right  => DroppedItemData(WeaponData.codec2, "weapon")
      ...
      case ObjectClass.peregrine_armor_siphon           => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.peregrine_armor_siphon_left      => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.peregrine_armor_siphon_right     => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.peregrine_dual_machine_gun       => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.peregrine_dual_machine_gun_left  => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.peregrine_dual_machine_gun_right => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.peregrine_dual_rocket_pods       => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.peregrine_mechhammer             => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.peregrine_mechhammer_left        => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.peregrine_mechhammer_right       => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.peregrine_ntu_siphon             => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.peregrine_ntu_siphon_left        => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.peregrine_ntu_siphon_right       => DroppedItemData(WeaponData.codec2, "siphon")
      case ObjectClass.peregrine_particle_cannon        => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.peregrine_sparrow                => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.peregrine_sparrow_left           => DroppedItemData(WeaponData.codec2, "weapon")
      case ObjectClass.peregrine_sparrow_right          => DroppedItemData(WeaponData.codec2, "weapon")
